function [curr, x] = solver(N, f, L, r, V)
% Pocklington integro-differential equation solver.
...
%
% Returns
%   curr : spatial distribution of current over a dipole [A]
